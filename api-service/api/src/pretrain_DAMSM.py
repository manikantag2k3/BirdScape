...
from api.src.misc.utils import build_super_images
from api.src.misc.losses import sent_loss, words_loss
...
def train(
    ...
    for step, data in enumerate(dataloader, 0):
        ...
        if step % UPDATE_INTERVAL == 0:
            ...
            # Use .item() to convert 0-dim tensors to numbers
...
def evaluate(dataloader, cnn_model, rnn_model, batch_size):
    ...
    for step, data in enumerate(dataloader, 0):
        ...
        # Fix: Use the last element of real_imgs list which is the highest resolution image
        words_features, sent_code = cnn_model(real_imgs[-1])  # Changed this line
