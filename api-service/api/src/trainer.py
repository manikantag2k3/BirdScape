...
from api.src.misc.config import cfg
from api.src.misc.utils import mkdir_p
from api.src.misc.utils import build_super_images, build_super_images2
from api.src.misc.utils import weights_init, load_params, copy_G_params
from api.src.model import G_DCGAN, G_NET
from api.src.dataset import prepare_data
from api.src.model import RNN_ENCODER, CNN_ENCODER

from api.src.misc.losses import words_loss
from api.src.misc.losses import discriminator_loss, generator_loss, KL_loss
import os
import time
import numpy as np
...
class condGANTrainer(object):
    ...
    def gen_example(self, data_dic):
        if cfg.TRAIN.NET_G == "":
            ...
            if os.path.exists("api/models/bird_AttnGAN2/output/0_s_0_g0.png"):
                os.remove("api/models/bird_AttnGAN2/output/0_s_0_g0.png")
                os.remove("api/models/bird_AttnGAN2/output/0_s_0_g1.png")
                os.remove("api/models/bird_AttnGAN2/output/0_s_0_g2.png")
            
            if os.path.exists("api/models/bird_AttnGAN2/output/0_s_0_a0.png"):
                os.remove("api/models/bird_AttnGAN2/output/0_s_0_a0.png")
                os.remove("api/models/bird_AttnGAN2/output/0_s_0_a1.png")
